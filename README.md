...
* `train_with_word2vec_embedding.ipynb`: This file trains a 1D Convelutional Neural Net for review sentiment classification using `word2vec` embedding. (the embedded data set has a shape of (399850, 50, 300)). Unfortunately, my machine was not able to train it due to the memory size. So I turn to use Keras' built-in embedding layer instead.
